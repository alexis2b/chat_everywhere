...
/*
 * restrict_command.h
 * Comments in restrict_command.c
 */


#ifndef RESTRICT_COMMAND_H
#define RESTRICT_COMMAND_H

/* Functions declarations */
extern void restrict_command_init(void);
extern unsigned int get_cmd_min_level(const unsigned int);

#endif /* RESTRICT_COMMAND_H */
